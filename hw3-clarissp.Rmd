...
leaflet() %>% 
  ...
  # Since you did all three on a single map, having the layerGroups in here might have been helpful, especially to understand what the different maps showed.
